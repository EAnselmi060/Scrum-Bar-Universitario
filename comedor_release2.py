...
def menu():
    ...
    while True:
        ...
        print("4. Actualizar datos personales")
        print("5. Mostrar comprobante de pedidos")
        print("6. Salir")
        ...
        if opcion == "1":
            ...
            actualizar_datos_personales(estudiante)
        elif opcion == "5":
            mostrar_comprobante(estudiante)
        elif opcion == "6":
            break
        else:
...
def abonar_credito(estudiante):
    os.system ("cls")
    monto = float(pyip.inputFloat("Ingrese el monto que desea abonar: ",allowRegexes=[r'^\d*\.?\d*$'], blockRegexes=[(r'.*','¡Debe ingresar un número!')]))
...
def actualizar_datos_personales(estudiante):
    direccion = input("Ingrese su nueva dirección (deje en blanco si no desea actualizarla): ")
    telefono = input("Ingrese su nuevo teléfono (deje en blanco si no desea actualizarlo): ")

    estudiante.actualizar_datos_personales(direccion, telefono)
...
def mostrar_comprobante(estudiante):
    os.system ("cls")
    estudiante.mostrar_comprobante()
